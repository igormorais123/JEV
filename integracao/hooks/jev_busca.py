#!/usr/bin/env python
"""Hook PostToolUse (Grep, Glob, WebSearch, buscas do Gmail, Drive e Agenda): numa listagem
com muitos itens, o Jev diz por onde começar.

Injeta uma nota curta com os itens classificados como essenciais ao pedido vigente e os que
ficaram como irrelevantes com confiança ≥ 0,99. Não esconde nada: a listagem já está no
contexto. Lógica em `camadas/busca.py`.
...
def main():
    ...
    if ferramenta not in busca.FERRAMENTAS:
        return 0
