...
- **usa** — citação: [`docs/CAMADAS-CLAUDE-CODE.md`](../../docs/CAMADAS-CLAUDE-CODE.md), [`executor/shared.py`](../../executor/shared.py), [`integracao/camadas/ler.py`](../../integracao/camadas/ler.py)
