...
- **chama de outros arquivos** — [`busca.analisar`](../../integracao/camadas/busca.py#L138), [`busca.nota_para_o_agente`](../../integracao/camadas/busca.py#L177), [`nucleo.modo_vigente`](../../integracao/camadas/nucleo.py#L68), [`nucleo.pedido_vigente`](../../integracao/camadas/nucleo.py#L125), [`nucleo.registrar`](../../integracao/camadas/nucleo.py#L79)
- **parecidos (julgados pelo Jev)** — [`integracao/hooks/jev_sentinela.py`](../../integracao/hooks/jev_sentinela.py) (complementar, 0.24)
