...
- **parecidos (julgados pelo Jev)** — [`hermes/portoes/jev_gate_sono_memoria.py`](../../hermes/portoes/jev_gate_sono_memoria.py) (complementar, 0.31), [`lab/server.py`](../../lab/server.py) (complementar, 0.24), [`hermes/jev_hermes/checklist.py`](../../hermes/jev_hermes/checklist.py) (não julgado, 0.20)
