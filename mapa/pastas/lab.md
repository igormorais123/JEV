...
- **parecidos (julgados pelo Jev)** — [`research/hermes/VALIDACAO-LOCAL.md`](../../research/hermes/VALIDACAO-LOCAL.md) (complementar, 0.24), [`executor/publish_simple_round.py`](../../executor/publish_simple_round.py) (complementar, 0.21)
