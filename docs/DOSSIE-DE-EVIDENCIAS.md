...
O livro-caixa SQLite em `runs/ledger.sqlite3` registra **13.042 chamadas** liquidadas, somando **US$ 0,5297** do teto de US$ 5,00 autorizado — restam US$ 4,4703. O livro-caixa é a fonte única: os JSONL do laboratório são cópias do mesmo evento e somá-los junto contaria duas vezes, defeito que já esteve no painel e foi corrigido.
