...
**Mediu:** 19820 — 19820 de 27413 decisões em que a confiança difere da probabilidade da classe escolhida; maior diferença 0.50 (escolheu `reversivel` com probabilidade 0.5 e confiança 0)
...
**Mediu:** 0,2185 — 5991 de 27413 decisões com 1,0
...
**Mediu:** 5680,7 — p99 sobre 22492 chamadas respondidas; máximo 32256 ms. Incluindo os timeouts o p99 vira 7498 ms, que é a constante de timeout do cliente e não uma latência do modelo
...
| `H002` | O custo de uma chamada é essencialmente linear no tamanho do payload. | r de Pearson > 0,90 | **sustentada** | 0,9855 |
| `H003` | O tamanho do estado domina o custo: o resto do payload é ruído contábil. | r de Pearson > 0,85 | **sustentada** | 0,9388 |
| `H004` | A latência é dominada por custo fixo, não pelo tamanho do que se manda. | r de Pearson < 0,30 | **sustentada** | -0,012 |
...
| `H012` | A confiança relatada é a probabilidade da classe escolhida, não um número à parte. | nenhuma divergência acima de 0,01 | **FALSIFICADA** | 19820 |

- **H001** · fonte: livro-caixa, 3.180 recibos de decisão · mediana 614 ms com duas perguntas contra 594 ms com uma, em 4921 e 17571 chamadas
- **H002** · fonte: livro-caixa, recibos com custo e bytes · r de Pearson sobre 22492 recibos
- **H003** · fonte: livro-caixa, recibos · r de Pearson sobre 22492 recibos
- **H004** · fonte: livro-caixa, recibos · r de Pearson sobre 22627 recibos; latência mediana 601 ms
...
- **H011** · fonte: todos os artefatos com gabarito de classes · 27413 decisões conferidas contra os critérios declarados na própria chamada
- **H012** · fonte: R4-R7, campo `probabilidades` · 19820 de 27413 decisões em que a confiança difere da probabilidade da classe escolhida; maior diferença 0.50 (escolheu `reversivel` com probabilidade 0.5 e confiança 0)
...
| `H015` | A confiança é degenerada: 1,0 é de longe o valor mais comum. | fração com confiança == 1,0 acima de 0,50 | **FALSIFICADA** | 0,2185 |
...
- **H015** · fonte: livro-caixa, 3.180 decisões · 5991 de 27413 decisões com 1,0
...
| | hipótese | previa | veredito | mediu |
|---|---|---|---|---|
| `H027` | A distribuição de probabilidade quase sempre colapsa numa classe só. | fração degenerada > 0,70 | **FALSIFICADA** | 0,2472 |
...
| `H032` | A segunda opção quase nunca recebe massa. | fração com segunda == 0 acima de 0,70 | **FALSIFICADA** | 0,2472 |
...
- **H027** · fonte: livro-caixa, vetores de probabilidade das 3.180 decisões · 6776 de 27413 vetores
...
- **H031** · fonte: R4-R7 e livro-caixa · 27653 vetores conferidos
- **H032** · fonte: livro-caixa, vetores de probabilidade · 6776 de 27413
...
| | hipótese | previa | veredito | mediu |
|---|---|---|---|---|
| `H037` | A latência mediana cabe dentro de um passo interativo. | mediana < 700 | **sustentada** | 598,6 |
...
| `H046` | O paralelismo de oito linhas não degradou a latência. | razão < 1,5 | **sustentada** | 1,066 |
...
- **H037** · fonte: livro-caixa, 3.180 recibos · 22492 chamadas respondidas
- **H038** · fonte: livro-caixa, recibos de chamadas respondidas (emenda de 2026-09-20) · p99 sobre 22492 chamadas respondidas; máximo 32256 ms. Incluindo os timeouts o p99 vira 7498 ms, que é a constante de timeout do cliente e não uma latência do modelo
- **H039** · fonte: livro-caixa, recibos de chamadas respondidas (emenda de 2026-09-20) · p99 5681 ms sobre mediana 599 ms, em chamadas respondidas
- **H040** · fonte: livro-caixa, recibos · mediana de 22492 chamadas
...
- **H042** · fonte: livro-caixa, agrupado por experimento · shared-lab 69.0%, shared-e15 24.6%, shared-router 2.9%
...
- **H044** · fonte: livro-caixa, recibos · quartil superior 33434 nUSD contra inferior 23563 nUSD
- **H045** · fonte: livro-caixa, recibos · 27847 nUSD contra 23269 nUSD
- **H046** · fonte: livro-caixa, recibos por consumidor · paralelo 602 ms em 22406 contra sequencial 565 ms em 200
- **H047** · fonte: livro-caixa, tabela attempts · 266 falhas em 24297 tentativas: success 23867, reserved 164, timeout 119, http_error 107, sent 32, invalid_response 8
- **H048** · fonte: livro-caixa, tabela attempts com uso registrado · mediana sobre 22492 recibos; máximo 134
