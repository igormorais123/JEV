...
**Mediu:** 19843 — 19843 de 27438 decisões em que a confiança difere da probabilidade da classe escolhida; maior diferença 0.50 (escolheu `reversivel` com probabilidade 0.5 e confiança 0)
...
**Mediu:** 0,2184 — 5992 de 27438 decisões com 1,0
...
**Mediu:** 5661,6 — p99 sobre 22513 chamadas respondidas; máximo 32256 ms. Incluindo os timeouts o p99 vira 7498 ms, que é a constante de timeout do cliente e não uma latência do modelo
...
| `H003` | O tamanho do estado domina o custo: o resto do payload é ruído contábil. | r de Pearson > 0,85 | **sustentada** | 0,9387 |
...
| `H012` | A confiança relatada é a probabilidade da classe escolhida, não um número à parte. | nenhuma divergência acima de 0,01 | **FALSIFICADA** | 19843 |

- **H001** · fonte: livro-caixa, 3.180 recibos de decisão · mediana 615 ms com duas perguntas contra 594 ms com uma, em 4925 e 17588 chamadas
- **H002** · fonte: livro-caixa, recibos com custo e bytes · r de Pearson sobre 22513 recibos
- **H003** · fonte: livro-caixa, recibos · r de Pearson sobre 22513 recibos
- **H004** · fonte: livro-caixa, recibos · r de Pearson sobre 22648 recibos; latência mediana 601 ms
...
- **H011** · fonte: todos os artefatos com gabarito de classes · 27438 decisões conferidas contra os critérios declarados na própria chamada
- **H012** · fonte: R4-R7, campo `probabilidades` · 19843 de 27438 decisões em que a confiança difere da probabilidade da classe escolhida; maior diferença 0.50 (escolheu `reversivel` com probabilidade 0.5 e confiança 0)
...
- **H015** · fonte: livro-caixa, 3.180 decisões · 5992 de 27438 decisões com 1,0
...
- **H027** · fonte: livro-caixa, vetores de probabilidade das 3.180 decisões · 6779 de 27438 vetores
...
- **H031** · fonte: R4-R7 e livro-caixa · 27678 vetores conferidos
- **H032** · fonte: livro-caixa, vetores de probabilidade · 6779 de 27438
...
| `H046` | O paralelismo de oito linhas não degradou a latência. | razão < 1,5 | **sustentada** | 1,01 |
...
- **H037** · fonte: livro-caixa, 3.180 recibos · 22513 chamadas respondidas
- **H038** · fonte: livro-caixa, recibos de chamadas respondidas (emenda de 2026-09-20) · p99 sobre 22513 chamadas respondidas; máximo 32256 ms. Incluindo os timeouts o p99 vira 7498 ms, que é a constante de timeout do cliente e não uma latência do modelo
...
- **H040** · fonte: livro-caixa, recibos · mediana de 22513 chamadas
...
- **H044** · fonte: livro-caixa, recibos · quartil superior 33479 nUSD contra inferior 23565 nUSD
- **H045** · fonte: livro-caixa, recibos · 27847 nUSD contra 23269 nUSD
- **H046** · fonte: livro-caixa, recibos por consumidor · paralelo 602 ms em 22406 contra sequencial 596 ms em 221
- **H047** · fonte: livro-caixa, tabela attempts · 266 falhas em 24318 tentativas: success 23888, reserved 164, timeout 119, http_error 107, sent 32, invalid_response 8
- **H048** · fonte: livro-caixa, tabela attempts com uso registrado · mediana sobre 22513 recibos; máximo 135
