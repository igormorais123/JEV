...
**Mediu:** 29423 — 29423 de 44429 decisões em que a confiança difere da probabilidade da classe escolhida; maior diferença 0.50 (escolheu `reversivel` com probabilidade 0.5 e confiança 0)
...
**Mediu:** 0,2768 — 12403 de 44813 decisões com 1,0
...
**Mediu:** 6247,6 — p99 sobre 31778 chamadas respondidas; máximo 32256 ms. Incluindo os timeouts o p99 vira 7339 ms, que é a constante de timeout do cliente e não uma latência do modelo
...
|---|---|---|---|---|
| `H001` | Mandar duas perguntas no mesmo payload não custa mais latência que mandar uma. | razão entre as medianas < 1,3 | **sustentada** | 0,918 |
...
| `H012` | A confiança relatada é a probabilidade da classe escolhida, não um número à parte. | nenhuma divergência acima de 0,01 | **FALSIFICADA** | 29423 |

- **H001** · fonte: livro-caixa, 3.180 recibos de decisão · mediana 642 ms com duas perguntas contra 699 ms com uma, em 5591 e 24046 chamadas
- **H002** · fonte: livro-caixa, recibos com custo e bytes · r de Pearson sobre 31778 recibos
- **H003** · fonte: livro-caixa, recibos · r de Pearson sobre 31778 recibos
- **H004** · fonte: livro-caixa, recibos · r de Pearson sobre 31913 recibos; latência mediana 720 ms
...
- **H011** · fonte: todos os artefatos com gabarito de classes · 44429 decisões conferidas contra os critérios declarados na própria chamada
- **H012** · fonte: R4-R7, campo `probabilidades` · 29423 de 44429 decisões em que a confiança difere da probabilidade da classe escolhida; maior diferença 0.50 (escolheu `reversivel` com probabilidade 0.5 e confiança 0)
...
| `H015` | A confiança é degenerada: 1,0 é de longe o valor mais comum. | fração com confiança == 1,0 acima de 0,50 | **FALSIFICADA** | 0,2768 |
...
- **H015** · fonte: livro-caixa, 3.180 decisões · 12403 de 44813 decisões com 1,0
...
| | hipótese | previa | veredito | mediu |
|---|---|---|---|---|
| `H027` | A distribuição de probabilidade quase sempre colapsa numa classe só. | fração degenerada > 0,70 | **FALSIFICADA** | 0,3075 |
...
| `H032` | A segunda opção quase nunca recebe massa. | fração com segunda == 0 acima de 0,70 | **FALSIFICADA** | 0,3075 |
...
- **H027** · fonte: livro-caixa, vetores de probabilidade das 3.180 decisões · 13781 de 44813 vetores
...
- **H031** · fonte: R4-R7 e livro-caixa · 45053 vetores conferidos
- **H032** · fonte: livro-caixa, vetores de probabilidade · 13781 de 44813
...
| | hipótese | previa | veredito | mediu |
|---|---|---|---|---|
| `H037` | A latência mediana cabe dentro de um passo interativo. | mediana < 700 | **FALSIFICADA** | 718 |
| `H038` | A cauda de latência não estoura o orçamento de um gancho de editor. | p99 < 3000 | **FALSIFICADA** | 6247,6 |
| `H039` | A latência tem cauda longa em relação à mediana. | p99/p50 > 3 | **sustentada** | 8,7 |
...
| `H042` | O gasto do estudo está concentrado em poucas rodadas. | fração das três maiores > 0,80 | **sustentada** | 0,9602 |
...
| `H046` | O paralelismo de oito linhas não degradou a latência. | razão < 1,5 | **sustentada** | 0,682 |
...
- **H037** · fonte: livro-caixa, 3.180 recibos · 31778 chamadas respondidas
- **H038** · fonte: livro-caixa, recibos de chamadas respondidas (emenda de 2026-09-20) · p99 sobre 31778 chamadas respondidas; máximo 32256 ms. Incluindo os timeouts o p99 vira 7339 ms, que é a constante de timeout do cliente e não uma latência do modelo
- **H039** · fonte: livro-caixa, recibos de chamadas respondidas (emenda de 2026-09-20) · p99 6248 ms sobre mediana 718 ms, em chamadas respondidas
...
- **H042** · fonte: livro-caixa, agrupado por experimento · shared-lab 74.3%, shared-e15 16.1%, shared-router 5.6%
...
- **H044** · fonte: livro-caixa, recibos · quartil superior 61160 nUSD contra inferior 28020 nUSD
- **H045** · fonte: livro-caixa, recibos · 27889 nUSD contra 23394 nUSD
- **H046** · fonte: livro-caixa, recibos por consumidor · paralelo 689 ms em 29794 contra sequencial 1010 ms em 1243
- **H047** · fonte: livro-caixa, tabela attempts · 274 falhas em 33654 tentativas: success 33153, reserved 227, timeout 119, http_error 107, sent 40, invalid_response 8
- **H048** · fonte: livro-caixa, tabela attempts com uso registrado · mediana sobre 31778 recibos; máximo 2507
